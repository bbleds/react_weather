...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var WeatherMsg = __webpack_require__(221);
	...
	var Weather = React.createClass({
	  ...
	  renderMessage: function renderMessage() {
	    if (this.state.isLoading) {
	      ...
	      return React.createElement(WeatherMsg, { location: this.state.location, temp: this.state.temp });
	    } else {
	      return React.createElement(
	        'h3',
	        null,
	        'To see current weather for a city, enter a cityname in the area above'
	      );
	    }
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var api_key = process.env.OPEN_WEATHER_API_KEY;
	var open_weather_map_url = 'http://api.openweathermap.org/data/2.5/weather?appid=b25fe0f7a3e7ab99286d813ee8225825&units=imperial';
